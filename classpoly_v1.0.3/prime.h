...
// SUPERSEDED BY PRIMES.H (which uses primesieve plus a table of small primes), do not use this
...
#define PRIME_BIG           0           // make nonzero to support prime enumeration to 2^43, otherwise default is 2^39
...
prime_enum_ctx_t *prime_enum_start (long start, long end, int powers);      // enumerates primes (or prime powers p^k with k <= powers) in [start,end]
                                                                            // use powers=-1 to get all prime powers
