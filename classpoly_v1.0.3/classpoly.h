...
#define CLASSPOLY_VERSION_STRING	"1.0.3"
...
static inline char *H_dir (void)
{
	...
	s = getenv("CLASSPOLY_H_DIR");								// explicit override of class polynomial output directory
	if ( s && s[0] ) { snprintf (_H_dir_str, sizeof(_H_dir_str), "%s", s); return _H_dir_str; }
	s = getenv("HOME");
