...
void _ff_inv_from_j (ff_t *x, ff_t *j, int inv)
{
	...
	case INV_W2W3E1: case INV_W2W5E1: case INV_W2W7E1: case INV_W2W11E2: case INV_W2W13E1: case INV_W3W7E1: case INV_W3W11E2: ff_inv_double_eta_from_j(x,j,inv); break;
	default:
...
void _ff_j_from_inv (ff_t *j, ff_t *x, int inv)
{
	...
	case INV_W3W5E1: case INV_W2W3E2: case INV_W2W5E2: case INV_W2W7E2: case INV_W3W3E2: case INV_W3W3E1: case INV_W5W5E1:
	case INV_W2W3E1: case INV_W2W5E1: case INV_W2W7E1: case INV_W2W11E2: case INV_W2W13E1:  case INV_W2W17E1: case INV_W3W7E1:case INV_W3W11E2:  ff_inv_j_from_double_eta (j,x,inv); break;
...
void ff_2j_from_inv (ff_t j[2], ff_t *x, int inv)
{
	...
	case INV_W3W5E1: case INV_W2W3E2: case INV_W2W5E2: case INV_W2W7E2:  case INV_W3W3E2: case INV_W3W3E1: case INV_W5W5E1:
	case INV_W2W3E1: case INV_W2W5E1: case INV_W2W7E1: case INV_W2W11E2: case INV_W2W13E1: case INV_W2W17E1:  case INV_W3W7E1: case INV_W3W11E2: ff_inv_2j_from_double_eta(j,x,inv); break;
	default:
...
int ff_inv_from_2j (ff_t x[2], ff_t *j1, ff_t *j2, int inv)
{
	...
	case INV_W3W5E1: case INV_W2W3E2: case INV_W2W5E2: case INV_W2W7E2:  case INV_W3W3E2: case INV_W3W3E1: case INV_W5W5E1:
	case INV_W2W3E1: case INV_W2W5E1: case INV_W2W7E1: case INV_W2W11E2: case INV_W2W13E1: case INV_W2W17E1:  case INV_W3W7E1: case INV_W3W11E2:  return ff_inv_double_eta_from_2j(x,j1,j2,inv);
	default:
...
int ff_j_from_2inv (ff_t *j, ff_t *x1, ff_t *x2, int inv)
{
	switch (inv) {
	case INV_W3W5E1: case INV_W2W3E2: case INV_W2W5E2: case INV_W2W7E2:  case INV_W3W3E2: case INV_W3W3E1: case INV_W5W5E1:
	case INV_W2W3E1: case INV_W2W5E1: case INV_W2W7E1: case INV_W2W11E2: case INV_W2W13E1:  case INV_W2W17E1: case INV_W3W7E1: case INV_W3W11E2:  return ff_inv_j_from_2double_eta (j,x1,x2,inv);
	default:
...
static inline void ff_inv_power (ff_t *x, ff_t *w, int inv)
{
	...
	switch (inv) {
	case INV_W2W3E1:  _ff_square(t,*w); _ff_mult(t,t,*w); ff_square(t,t); _ff_square(*x,t); return;																	// twelfth
	case INV_W3E2: case INV_W2W11E2: case INV_W2W3E2: case INV_W2W5E1: case INV_W3W3E1: case INV_W3W11E2:  _ff_square(t,*w); ff_mult(t,t,*w); _ff_square(*x,t); return;	// sixth
	case INV_W2W7E1: _ff_square(t,*w); _ff_square(*x,t); return;																							// fourth
	case INV_W5E2:  case INV_W3W5E1: case INV_W2W5E2: case INV_W3W3E2: case INV_W5W5E1:  case INV_W2W17E1:  _ff_square(t,*w); ff_mult(*x,t,*w); return;				// cube
	case INV_W7E2: case INV_W2W7E2: case INV_W2W13E1: case INV_W3W7E1:  _ff_square(*x,*w); return;															// square
...
static inline int ff_inv_root (ff_t *x, ff_t *w, int inv)
{
	...
	switch (inv ) {
	case INV_W2W3E1:  ff_cbrt(&t,w); if ( ! ff_sqrt(&t,&t) ) return 0; if ( ! ff_sqrt(x,&t) ) return 0; else return 1;										// twelfth
	case INV_W3E2: case INV_W2W3E2: case INV_W2W5E1: case INV_W2W11E2: case INV_W3W3E1: ff_cbrt(&t,w); if ( ! ff_sqrt(x,&t) ) return 0; else return 1;		// sixth
	case INV_W7E2: case INV_W2W7E2: case INV_W2W13E1:  case INV_W3W7E1:  if ( ! ff_sqrt(x,w) ) return 0; else  return 1;								// fourth
	case INV_W5E2: case INV_W3W5E1: case INV_W2W5E2: case INV_W3W3E2: case INV_W5W5E1: case INV_W3W11E2:  case INV_W2W17E1: ff_cbrt(x,w); return 1;	// cube
	case INV_W2W7E1: if ( ! ff_sqrt(&t,w) ) return 0; if ( ! ff_sqrt(x,&t) ) return 0; else return 1;														// square
...
void ff_inv_double_eta_from_j (ff_t *w, ff_t *j, int inv)	// may return either w or its conjugate, you must pick one (consistently!)
{
	...
	n = ff_poly_distinct_roots(r,f,phi_fj_fdeg);
	if ( !n || n > 4 ) {
		if ( inv==INV_W3W5E1 || (inv > INV_MAX_SPECIFIC && ((inv-INV_DOUBLE_ETA)%2)) ) { printf ("Error, got %d != 1,2,4 roots for double eta-quotient when converting from j=%ld (p=%ld)\n", n, _ff_get_ui(*j), _ff_p); exit(0); }
...
// Return every j in F_p with Phi_inv(x,J)=0, correctly applying the invariant power.
// Unlike ff_multi_j_from_inv(...,desired=0) this applies ff_inv_power (needed for the
// E1/E2 double-eta codes), and unlike ff_2j_from_inv it does not abort when fewer than
// two roots lie in F_p (which happens for Atkin invariants where the second j is defined
// only over F_{p^2}).  Returns the number of distinct roots found (j[] must hold >= jdeg).
int ff_all_j_from_inv (ff_t j[], ff_t *x, int inv)
{
	ff_t xp, f[PHI_MAX_JDEG+1];
	int d_f;

	if ( ! inv ) { _ff_set(j[0],*x); return 1; }
	inv_load_phi_fj (inv);
	if ( phi_fj_jdeg == 1 ) { _ff_j_from_inv (j, x, inv); return 1; }
	inv_reduce_phi_fj (inv,1);
	ff_inv_power (&xp, x, inv);
	bipoly_eval_ff (f, phi_fj_jdeg, phi_fj, phi_fj_terms, 0, xp);
	d_f = ff_poly_degree (f, phi_fj_jdeg);
	ff_poly_monic (f, &d_f, f, d_f);
	return ff_poly_distinct_roots (j, f, d_f);
}
